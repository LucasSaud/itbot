class Command {
     ...
     * @returns {object} - An object with command details or a message if the input is not a recognized command.
     */
    check(inputString) {
  ...
  for (const test of cmdTests) {
    ...
    if (typeof result === "object") {
      ...
      console.log(`Input: "${test}", Command found: ${command}, Argument01: ${argument01 || 'null'}, Argument02: ${argument02 || 'null'}`);
    } else {
      console.log(result);
    }
  }
